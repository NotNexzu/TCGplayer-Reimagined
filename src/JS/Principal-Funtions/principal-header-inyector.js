class TCGHeader extends HTMLElement {
    connectedCallback() {
        const isDev = this.getAttribute('variant') === 'dev';

        const logoBlock = isDev
            ? `<a href="/index.html" class="logo">
        <div class="dlogo-icon"><img src="/assets/brand/logo-original.svg" alt="TCGPlayerDev"></div>
        <span class="logo-text">Reimagined DEV</span>
      </a>`
            : `<a href="/index.html" class="logo">
        ...
        const devToggleBlock = isDev
            ? `<a href="/index.html" id="developerToggleoff" class="is-active" aria-label="Developer Mode ON — Click to exit">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            : `<a href="/dev-index.html" id="developerToggleoff" aria-label="Enter Developer Mode">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M16 18 22 12 16 6"/>
            <path d="M8 6 2 12l6 6"/>
          </svg>
...
<header>
    <div class="container">
      ...
      <nav class="main-nav">
        ...
        ${devToggleBlock}
        <a href="/account/login.html" class="btn-login">Login</a>
      </nav>
    </div>
</header>
`;
...
/* Uso:
   <tcg-header></tcg-header>              -> header normal (index.html)
   <tcg-header variant="dev"></tcg-header> -> header modo desarrollador (dev-index.html)
